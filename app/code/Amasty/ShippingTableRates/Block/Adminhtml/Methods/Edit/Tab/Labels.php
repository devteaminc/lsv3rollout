...
class Labels extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        if (!$this->_storeManager->isSingleStoreMode()) {
            ...
            $this->createStoreSpecificFieldset($form, $storesData);
        }
    ...
    private function prepareStoresData($collection)
    {
        $storesData = [];
     ...
     */
    private function createStoreSpecificFieldset($form, $storesData)
    {
        ...
        $fieldSetStores->setRenderer($renderer);
                ...
                foreach ($stores as $store) {
                    ...
                    $fieldSetStores->addField(
                        ...
                        [
                            ...
                            'value' => isset($storesData[$store->getId()])
                                ? $storesData[$store->getId()]['label']
                                : '',
                    ...
                    $fieldSetStores->addField(
                        ...
                        [
                            ...
                            'style' => 'height:15px;',
                            'value' => isset($storesData[$store->getId()])
                                ? $storesData[$store->getId()]['comment']
                                : '',
                            'fieldset_html_class' => 'store',
                        ]
                    );
