...
namespace Amasty\Orderattr\Model\ResourceModel\Relation\Grid;
...
class Collection extends \Magento\Framework\View\Element\UiComponent\DataProvider\SearchResult
{
    ...
    public function __construct(
        ...
        $mainTable = 'amasty_orderattr_attributes_relation',
        $resourceModel = '\Amasty\Orderattr\Model\ResourceModel\Relation'
    ) {
    ...
    protected function _initSelect()
    {
        ...
        $this->getSelect()
            ->joinInner(
                ['detail' => $this->getTable('amasty_orderattr_attributes_relation_details')],
                'main_table.relation_id = detail.relation_id',
                ['detail.attribute_id']
            )
            ->joinInner(
                ['attribute' => $this->getTable('amasty_orderattr_order_eav_attribute')],
