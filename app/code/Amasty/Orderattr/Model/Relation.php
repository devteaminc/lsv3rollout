...
{
    /**
     * @var \Amasty\Orderattr\Model\RelationDetailsFactory
     */
    ...
    public function __construct(
        ...
        \Amasty\Orderattr\Model\ResourceModel\Relation $resource,
        \Amasty\Orderattr\Model\ResourceModel\Relation\Collection $resourceCollection,
        \Amasty\Orderattr\Model\RelationDetailsFactory $detailsFactory,
        array $data = []
    ) {
    ...
    {
        $this->_init('Amasty\Orderattr\Model\ResourceModel\Relation');
    }
