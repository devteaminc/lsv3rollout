...
class Analytics extends Generic implements TabInterface{
    ...
    protected function _prepareForm()
    {
        ...
        $fldInfo->addField('utm_campaign', 'text', array(
            ...
            'name'      => 'utm_campaign',
            'note' => __('<b>Required.</b> Used for keyword analysis. Use <b>utm_campaign</b> to identify a specific product promotion or strategic campaign.<br/><i>Example:</i> utm_campaign=spring_sale')
        ));
