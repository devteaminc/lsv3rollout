    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'values' => $this->_cancelConditionOptions->toOptionArray(),
                'note' => __('Note! Additional to the listed actions Order Placed action will always cancel the abandoned cart email')
            ]
        );
