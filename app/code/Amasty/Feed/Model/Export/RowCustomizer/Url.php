    ...
    public function addData(&$dataRow, $productId)
    {
        ...
        if ($this->_urlRewrites && isset($this->_urlRewrites[$productId])) {
            ...
            $pathMode = $this->scopeConfig->getValue(
                'amasty_feed/general/category_path', ScopeInterface::SCOPE_STORE
            );
            ...
            if (count($urlRewrites) > 1 && $pathMode != Path::USE_DEFAULT) {
                ...
                $urlWithCategory = isset($urlRewrites[$lastCategoryId]) ? $urlRewrites[$lastCategoryId] : end($urlRewrites);
            }
